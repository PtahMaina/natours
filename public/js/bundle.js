...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGVlbXdhc3MiLCJhIjoiY2wxZ2Vyd2pnMDAwcTNkbzUwdjVkZnVjaSJ9.5-fCq0keKQVbiFpgs5l5VA';
...
/* eslint-disable */
module.exports = hideAlert = function hideAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
}; // type is 'success' or 'error'


module.exports = showAlert = function showAlert(type, msg) {
  hideAlert();
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51Kk2iTAFRWSgwJUTipJh9bOwIKHWkhSI9wdS1wfoZqncMqNgQ8rkfZZAPFe4pIpT4nmtuF47dbs9W7Y5HS6whHlI00yHb3h4wu');
            _context.prev = 1;
            _context.next = 4;
